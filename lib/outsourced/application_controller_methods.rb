  ...
  module ApplicationControllerMethods
    ...
    class Authenticator
      ...
      def oauth10_request_token
        oauth10_token && oauth10_token.is_a?(::Outsourced::Oauth::RequestToken) ? oauth10_token : nil
      end

      def oauth10_access_token
        oauth10_token && oauth10_token.is_a?(::Outsourced::Oauth::AccessToken) ? oauth10_token : nil
      end
